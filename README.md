...
A versão alfa do jogo funciona por linha de comando através do terminal do seu computador. Os únicos pré-requisitos é ter o  Python instalado [(dowload)](https://www.python.org/downloads/) no seu computador e um terminal também.
